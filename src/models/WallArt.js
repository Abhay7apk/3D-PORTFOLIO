      ...
      <div className="tile-grid">
        ...
        <div className="tile">
          <div className="tile-content">
            SINGING <br />
            <span className="description">
              MUSIC&apos; & MAKING IT SO FUN FOR ME , ALSO BEAT MAKING , COMPOSING AND 
              OFCOURSE WRITING .
            </span>
          </div>
        </div>
        <div className="tile">
          <div className="tile-content">
            ...
            <span className="description">
              ...
              result. Now, I&apos;ve moved on to Blender (JUST STARTING OUT) and animation.
            </span>
          </div>
        </div>
        <div className="tile">
          <div className="tile-content">
            READING <br />
            <span className="description">
              I believe my specific taste is &quot;FANTASY AND MYSTRY&quot;, sorta
